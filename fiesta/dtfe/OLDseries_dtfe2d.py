...
class SeriesDelaunay2D:
    ...
    def set_buffer(self, boxsize, buffer_length):
        ...
        self.usebuffer = True
        self.useperiodic = False
        x_buffer, y_buffer = boundary.buffer_random_particles_2d(
    ...
    def set_periodic(self, boxsize, buffer_length):
        ...
        self.boxsize = boxsize
        self.buffer_length = buffer_length
        x_periodic, y_periodic = boundary.buffer_periodic_particles_2d(
            self.points[:, 0], self.points[:, 1], self.boxsize, self.buffer_length
        )
