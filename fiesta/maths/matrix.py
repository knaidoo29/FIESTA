...
def det3by3(
        m00: Tuple[float, np.ndarray], m01: Tuple[float, np.ndarray], m02: Tuple[float, np.ndarray], 
        m10: Tuple[float, np.ndarray], m11: Tuple[float, np.ndarray], m12: Tuple[float, np.ndarray], 
        m20: Tuple[float, np.ndarray], m21: Tuple[float, np.ndarray], m22: Tuple[float, np.ndarray]
    ...
    """
    det = m00*m11*m22 + m01*m12*m20 + m02*m10*m21 - m02*m11*m20 - m01*m10*m22 - m00*m12*m21
    return det


def det4by4(
        m00: Tuple[float, np.ndarray], m01: Tuple[float, np.ndarray], m02: Tuple[float, np.ndarray], m03: Tuple[float, np.ndarray], 
        m10: Tuple[float, np.ndarray], m11: Tuple[float, np.ndarray], m12: Tuple[float, np.ndarray], m13: Tuple[float, np.ndarray], 
        m20: Tuple[float, np.ndarray], m21: Tuple[float, np.ndarray], m22: Tuple[float, np.ndarray], m23: Tuple[float, np.ndarray],
        m30: Tuple[float, np.ndarray], m31: Tuple[float, np.ndarray], m32: Tuple[float, np.ndarray], m33: Tuple[float, np.ndarray],
    ) -> Tuple[float, np.ndarray]:
    """
    Computes the determinant of a matrix or a series of matrices
