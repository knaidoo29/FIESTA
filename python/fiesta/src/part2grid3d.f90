...
subroutine p2g_cic_3d(x, y, z, f, boxsize, ngrid, npart, fgrid)
...
end subroutine p2g_cic_3d


subroutine p2g_tsc_3d(x, y, z, f, boxsize, ngrid, npart, fgrid)
